// prisma/seed/basic-3-history.ts
// Seed script for Basic 3 History curriculum
...
const SUBJECT_FRIENDLY_NAME = 'Basic 3 History';
const SUBJECT_JSON_FILE = 'basic-3-history.json';
...
// Optional: strip inline [cite: ###] markers from descriptions if you want
...
async function main() {
  try {
    ...
    console.error('❌ Error seeding Basic 3 History:', err);
    process.exitCode = 1;
  } finally {
