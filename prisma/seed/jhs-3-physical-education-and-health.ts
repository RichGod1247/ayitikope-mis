...
/**
 * Type shapes based on jhs-3-physical-education-and-health.json
 */
...
async function main() {
  const filePath = path.join(
    ...
    'seed',
    'curriculum',
    'jhs-3-physical-education-and-health.json'
  );

  console.log(
    '📖 Loading JHS 3 Physical Education and Health curriculum from:',
    filePath
  );
  ...
  console.log(
    '✅ Seeded JHS 3 Physical Education and Health with id:',
    subject.id
  );
...
main()
  .catch((e) => {
    console.error(
      '❌ Error seeding JHS 3 Physical Education and Health:',
      e
    );
    process.exitCode = 1;
  })
