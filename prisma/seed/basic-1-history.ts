// prisma/seed/basic-1-history.ts
// Seed script for Basic 1 History curriculum
...
const SUBJECT_FRIENDLY_NAME = 'Basic 1 History';
const SUBJECT_JSON_FILE = 'basic-1-history.json';

// -------- MODEL ALIASES (same pattern as the working Creative Arts scripts) --------
...
async function main() {
  try {
    ...
    console.error('❌ Error seeding Basic 1 History:', err);
    process.exitCode = 1;
  } finally {
