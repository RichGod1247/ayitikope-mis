// prisma/seed/basic-3-science.ts
...
async function main() {
  ...
  console.log(
    `📖 Loading Basic 3 Science curriculum from: ${jsonPath}`
  );
  ...
  console.log(
    `✅ Seeded Basic 3 Science with id: ${created.id}`
  );
  console.log(
...
main()
  .catch((err) => {
    console.error("❌ Error seeding Basic 3 Science:", err);
    process.exit(1);
  })
  .finally(async () => {
