...
/**
 * Type shapes based on jhs-2-physical-education-and-health.json
 */
...
async function main() {
  const filePath = path.join(
    ...
    'seed',
    'curriculum',
    'jhs-2-physical-education-and-health.json'
  );

  console.log(
    '📖 Loading JHS 2 Physical Education and Health curriculum from:',
    filePath
  );
  ...
  console.log(
    '✅ Seeded JHS 2 Physical Education and Health with id:',
    subject.id
  );
...
main()
  .catch((e) => {
    console.error(
      '❌ Error seeding JHS 2 Physical Education and Health:',
      e
    );
    process.exitCode = 1;
  })
