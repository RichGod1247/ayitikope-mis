...
async function mainReal() {
  ...
  const seedPath = path.join(
    __dirname,
    "curriculum",
    "basic-1-physical-education-media.json"
  );

  console.log("📖 Loading B1 Physical Education media seed from:", seedPath);
  ...
  console.log("🎉 Done seeding B1 Physical Education media.");
...
async function main() {
  try {
    ...
    console.error("❌ Error in B1 Physical Education media seed:", err);
  } finally {
