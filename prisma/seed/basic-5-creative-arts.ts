// prisma/seed/basic-5-creative-arts.ts
// Seed script for Basic 5 Creative Arts curriculum (JSON part 2/4)
...
const SUBJECT_FRIENDLY_NAME = 'Basic 5 Creative Arts';
const SUBJECT_PART_PREFIX = 'basic-5-creative-arts-part-2';
...
async function main() {
  try {
    ...
    console.error('❌ Error seeding Basic 5 Creative Arts:', err);
    process.exitCode = 1;
  } finally {
