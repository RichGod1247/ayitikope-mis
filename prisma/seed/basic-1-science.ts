// prisma/seed/basic-1-science.ts
...
async function main() {
  ...
  console.log(
    `📖 Loading Basic 1 Science curriculum from: ${jsonPath}`
  );
  ...
  console.log(
    `✅ Seeded Basic 1 Science with id: ${created.id}`
  );
  console.log(
...
main()
  .catch((err) => {
    console.error("❌ Error seeding Basic 1 Science:", err);
    process.exit(1);
  })
  .finally(async () => {
