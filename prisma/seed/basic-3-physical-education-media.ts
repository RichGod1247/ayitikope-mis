...
async function mainReal() {
  ...
  const seedPath = path.join(
    __dirname,
    "curriculum",
    "basic-3-physical-education-media.json"
  );

  console.log("📖 Loading B3 Physical Education media seed from:", seedPath);
  ...
  console.log("🎉 Done seeding B3 Physical Education media.");
...
async function main() {
  try {
    ...
    console.error("❌ Error in B3 Physical Education media seed:", err);
  } finally {
