...
async function mainReal() {
  ...
  const seedPath = path.join(
    __dirname,
    "curriculum",
    "basic-4-physical-education-media.json"
  );

  console.log("📖 Loading B4 Physical Education media seed from:", seedPath);
  ...
  console.log("🎉 Done seeding B4 Physical Education media.");
...
async function main() {
  try {
    ...
    console.error("❌ Error in B4 Physical Education media seed:", err);
  } finally {
