...
async function mainReal() {
  ...
  const seedPath = path.join(
    __dirname,
    "curriculum",
    "basic-3-religious-and-moral-education-media.json"
  );

  console.log("📖 Loading B3 Religious and Moral Education media seed from:", seedPath);
  ...
  console.log("🎉 Done seeding B3 Religious and Moral Education media.");
...
async function main() {
  try {
    ...
    console.error("❌ Error in B3 Religious and Moral Education media seed:", err);
    process.exitCode = 1;
  } finally {
