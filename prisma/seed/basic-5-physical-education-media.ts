...
async function mainReal() {
  ...
  const seedPath = path.join(
    __dirname,
    "curriculum",
    "basic-5-physical-education-media.json"
  );

  console.log("📖 Loading B5 Physical Education media seed from:", seedPath);
  ...
  console.log("🎉 Done seeding B5 Physical Education media.");
...
async function main() {
  try {
    ...
    console.error("❌ Error in B5 Physical Education media seed:", err);
  } finally {
