// prisma/seed/basic-2-science.ts
...
async function main() {
  ...
  console.log(
    `📖 Loading Basic 2 Science curriculum from: ${jsonPath}`
  );
  ...
  console.log(
    `✅ Seeded Basic 2 Science with id: ${created.id}`
  );
  console.log(
...
main()
  .catch((err) => {
    console.error("❌ Error seeding Basic 2 Science:", err);
    process.exit(1);
  })
  .finally(async () => {
