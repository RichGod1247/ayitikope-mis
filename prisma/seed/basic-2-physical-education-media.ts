...
async function mainReal() {
  ...
  const seedPath = path.join(
    __dirname,
    "curriculum",
    "basic-2-physical-education-media.json"
  );

  console.log("📖 Loading B2 Physical Education media seed from:", seedPath);
  ...
  console.log("🎉 Done seeding B2 Physical Education media.");
...
async function main() {
  try {
    ...
    console.error("❌ Error in B2 Physical Education media seed:", err);
  } finally {
