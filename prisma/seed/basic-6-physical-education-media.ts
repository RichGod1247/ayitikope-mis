...
async function mainReal() {
  ...
  const seedPath = path.join(
    __dirname,
    "curriculum",
    "basic-6-physical-education-media.json"
  );

  console.log("📖 Loading B6 Physical Education media seed from:", seedPath);
  ...
  console.log("🎉 Done seeding B6 Physical Education media.");
...
async function main() {
  try {
    ...
    console.error("❌ Error in B6 Physical Education media seed:", err);
  } finally {
