// prisma/seed/basic-2-our-world-and-our-people.ts
...
async function main() {
  ...
  console.log(
    `📖 Loading Basic 2 Our World and Our People curriculum from: ${jsonPath}`
  );
  ...
  console.log(
    `✅ Seeded Basic 2 Our World and Our People with id: ${created.id}`
  );
  console.log(
...
main()
  .catch((err) => {
    console.error("❌ Error seeding Basic 2 Our World and Our People:", err);
    process.exit(1);
  })
  .finally(async () => {
