...
async function main() {
  ...
  console.log("📖 Loading Basic 6 Creative Arts media seed from:", jsonPath);
  ...
  console.log("✅ Basic 6 Creative Arts media seeded");
  console.log({ created, updated, total: created + updated });

  console.log("🔍 VERIFY (RUN YOUR 2 QUERIES):");
  console.log("  1) Count ONLY Basic 6 Creative Arts media (EXPECTED = " + (created + updated) + ")");
