//src/app/api/headteacher/assessment/items/lock/route.ts
...
export async function POST(req: Request) {
  ...
  if (!item.publishedAt && String(item.status ?? "").toUpperCase() !== "PUBLISHED") {
    return noStore(400, { ok: false, error: "ITEM_NOT_PUBLISHED" });
  }
