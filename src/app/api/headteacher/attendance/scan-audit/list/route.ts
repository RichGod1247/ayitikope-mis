// src/app/api/headteacher/attendance/scan-audit/list/route.ts
...
function isHeadteacherScanAuditRole(roleName: string | null | undefined) {
...
async function requireHeadteacherScanAuditReader(
  userId: string,
  tenantId: string,
) {
  ...
  if (!membership || !isHeadteacherScanAuditRole(roleName)) {
...
export async function GET(req: NextRequest) {
  try {
    ...
    await requireHeadteacherScanAuditReader(safe.userId, safe.tenantId);
